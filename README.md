...
##### 1. UCB-project as Team leader:Fake News detection algorithm (Machine Learning project)
...
##### 4. Ship Identification from Satellite images (Machine Learning project):  
